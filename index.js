...
let students = [
  { name: 'Aditya', regno: 'urk19cs2003', dob: '21-09-2001' },
  { name: 'Ruhan Sam', regno: 'urk19cs2002', dob: '25-09-2001' },
  { name: 'Mark', regno: 'urk19cs2001', dob: '13-05-1999' },
];
...
for (var i = 0; i < students.length; i++) {
  ...
  const textnode = document.createTextNode(
    `name: ${students[i]['name']} regno: ${students[i]['regno']}`
  );
